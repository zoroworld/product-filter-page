...
import SidebarContent from "./layouts/sidebarContent/SidebarContent.jsx";
    ...
    return (
      <div className="flex justify-center items-center ">
        <button
          disabled
          type="button"
          className="w-fit text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
